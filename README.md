...
Arduino library for STMPE610/811 resistive touch screen controllers. Original author: Adafruit. This is my working copy from the Arduino `libraries` tree. Version recorded in `library.properties`: 1.1.4. Upstream: <https://github.com/adafruit/Adafruit_STMPE610>.

**Source last updated:** 2021-11-30  
**Language:** C++ / Arduino  
**Target:** Arduino (*)  
